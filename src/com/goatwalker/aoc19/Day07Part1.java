  ...
  private void doit() throws Exception {
    ...
    try (BufferedReader br = new BufferedReader(new FileReader(filename))) {
      ...
      while ((line = br.readLine()) != null) {
        program = Arrays.stream(line.split(",")).mapToInt(Integer::parseInt).toArray();
      }
    }

    Permutation<Integer> permGen = new Permutation<Integer>();

    List<Integer[]> perms = permGen.permute(new Integer[] {5, 6, 7, 8, 9});
    ...
    while (true) {
      ...
      switch (op) {
        case 1:
          ...
          Log.out("Add: " + po.get(1) + " + " + po.get(2) + " = " + mem[mem[pos + 3]] + " into pos "
              + mem[pos + 3]);
        ...
        case 2:
          mem[mem[pos + 3]] = po.get(1) * po.get(2);
          Log.out("Mult: " + po.get(1) + " * " + po.get(2) + " = " + mem[mem[pos + 3]]
              + " into pos " + mem[pos + 3]);
        ...
        case 3:
          ...
          mem[mem[pos + 1]] = input;
          Log.out("Input #" + inputIndex + ": " + inputs + " = " + mem[mem[pos + 1]] + " into pos "
              + mem[pos + 1]);
          pos += 2;
          inputIndex++;
          break;
        ...
        case 8:
          ...
          Log.out((op == 5 ? "Less-than" : "Equal-to") + " p1=" + po.get(1) + " p2=" + po.get(2)
              + " result=" + mem[mem[pos + 3]] + " in pos " + mem[pos + 3]);
        ...
        case 99:
          return output;
        default:
          throw new Exception("for pos " + pos + " -- unknown opcode value " + mem[pos]
              + " - next 4 codes " + Arrays.toString(Arrays.copyOfRange(mem, pos, pos + 4)));
      }
    }
  }
}
