    ...
    private void doit() throws Exception
    {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filename)))
        {
            ...
            while ((line = br.readLine()) != null)
            {
                ...
                codes = Arrays.stream(line.split(","))
    ...
    private int intcode(int[] codes, int input) throws Exception
    {
        ...
        while (true)
        {
            ...
            case 3:
                ...
                Log.out("Input: " + input + " = " + codes[codes[pos + 1]]
                        + " into pos " + codes[pos + 1]);
                pos += 2;
                break;
            case 4:
                output =  po.get(1);
            ...
            case 8:
                ...
                Log.out((op == 5 ? "Less-than" : "Equal-to") + " p1="
                        ...
                        + codes[codes[pos + 3]] + " in pos " + codes[pos + 3]);
            ...
            default:
                throw new Exception("for pos " + pos
                        ...
                        + " - next 4 codes " + Arrays.toString(
                                Arrays.copyOfRange(codes, pos, pos + 4)));
            }
