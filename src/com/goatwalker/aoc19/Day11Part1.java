...
public class Day11Part1 {
  ...
  private void doit() throws Exception {
    ...
    while (comp.stillRunning()) {
      ...
      System.out.println("Setting " + curPos + " to color " + newColor + " and turning "
          + (newTurn == 0 ? " left" : "right") + ", curDir=" + curDir + ", newDir=" + newDir
          + ", numMoves=" + numMoves + ", num panels=" + panels.size());
      curDir = newDir;
