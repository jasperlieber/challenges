...
public class Day05Part1 {
  ...
  private void intcode(int[] origCodes, int input) throws Exception {
...

    {
      ...
      Log.out("pos " + pos + " - op " + op + " - paramModes " + paramModes + " - next 4 codes "
      ...
      if (op == 1 || op == 2) {
        ...
        for (int pp = 0; pp < 2; pp++) {
          ...
          params[pp] = (paramModes % 10 == 0) ? codes[codes[pos + 1 + pp]] // position mode
        ...
        Log.out("  params " + String.join(",", Arrays.toString(params)));
