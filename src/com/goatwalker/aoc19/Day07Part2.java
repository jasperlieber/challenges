...
public class Day07Part2 {
  ...
  private void doit() throws Exception {
    ...
    List<Integer[]> perms = permGen.permute(new Integer[] {9, 8, 7, 6, 5});
    ...
    for (Integer[] perm : perms) {
      ...
      if (maxOutput == null || lastOutput != null && lastOutput > maxOutput)
      ...
      while (running && output == null) {
        ...
        switch (op) {
          case 1:
            ...
            mem[mem[ip + 3]] = p1 + p2;
            Log.out(
                "Add: " + p1 + " + " + p2 + " = " + mem[mem[ip + 3]] + " into pos " + mem[ip + 3]);
          ...
          case 2:
            ...
            mem[mem[ip + 3]] = p1 * p2;
            Log.out(
                "Mult: " + p1 + " * " + p2 + " = " + mem[mem[ip + 3]] + " into pos " + mem[ip + 3]);
          ...
          case 3:
            ...
            mem[mem[ip + 1]] = input;
            Log.out("Input #" + inputIndex + ": " + inputs + " = " + mem[mem[ip + 1]] + " into pos "
                + mem[ip + 1]);
            ip += 2;
            inputIndex++;
            break;
          ...
          case 99:
            ...
            break;
          default:
            throw new Exception("for pos " + ip + " -- unknown opcode value " + mem[ip]
                + " - next 4 codes " + Arrays.toString(Arrays.copyOfRange(mem, ip, ip + 4)));
        }
